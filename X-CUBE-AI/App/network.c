...
#define AI_NETWORK_MODEL_SIGNATURE     "0x85e11d9e015e75b39d77ff75aef19a7f"
...
#define AI_TOOLS_DATE_TIME   "2026-09-08T10:17:00+0300"
...
AI_INTQ_INFO_LIST_OBJ_DECLARE(gemm_0_output_array_intq, AI_STATIC_CONST,
  ...
  AI_PACK_INTQ_INFO(
    AI_PACK_INTQ_SCALE(0.020445983856916428f),
    AI_PACK_INTQ_ZP(-128)))
...
AI_INTQ_INFO_LIST_OBJ_DECLARE(gemm_0_weights_array_intq, AI_STATIC_CONST,
  AI_BUFFER_META_FLAG_SCALE_FLOAT|AI_BUFFER_META_FLAG_ZEROPOINT_S8, 1,
  AI_PACK_INTQ_INFO(
    AI_PACK_INTQ_SCALE(0.0076153455302119255f),
    AI_PACK_INTQ_ZP(0)))
...
AI_INTQ_INFO_LIST_OBJ_DECLARE(gemm_1_output_array_intq, AI_STATIC_CONST,
  AI_BUFFER_META_FLAG_SCALE_FLOAT|AI_BUFFER_META_FLAG_ZEROPOINT_S8, 1,
  AI_PACK_INTQ_INFO(
    AI_PACK_INTQ_SCALE(0.07870989292860031f),
    AI_PACK_INTQ_ZP(-128)))
...
AI_INTQ_INFO_LIST_OBJ_DECLARE(gemm_1_weights_array_intq, AI_STATIC_CONST,
  AI_BUFFER_META_FLAG_SCALE_FLOAT|AI_BUFFER_META_FLAG_ZEROPOINT_S8, 1,
  AI_PACK_INTQ_INFO(
    AI_PACK_INTQ_SCALE(0.006933572702109814f),
    AI_PACK_INTQ_ZP(0)))
...
AI_INTQ_INFO_LIST_OBJ_DECLARE(gemm_2_output_array_intq, AI_STATIC_CONST,
  AI_BUFFER_META_FLAG_SCALE_FLOAT|AI_BUFFER_META_FLAG_ZEROPOINT_S8, 1,
  AI_PACK_INTQ_INFO(
    AI_PACK_INTQ_SCALE(0.40868183970451355f),
    AI_PACK_INTQ_ZP(9)))
...
AI_INTQ_INFO_LIST_OBJ_DECLARE(gemm_2_weights_array_intq, AI_STATIC_CONST,
  AI_BUFFER_META_FLAG_SCALE_FLOAT|AI_BUFFER_META_FLAG_ZEROPOINT_S8, 1,
  AI_PACK_INTQ_INFO(
    AI_PACK_INTQ_SCALE(0.008184743113815784f),
    AI_PACK_INTQ_ZP(0)))
...
AI_INTQ_INFO_LIST_OBJ_DECLARE(serving_default_input_10_output_array_intq, AI_STATIC_CONST,
  AI_BUFFER_META_FLAG_SCALE_FLOAT|AI_BUFFER_META_FLAG_ZEROPOINT_S8, 1,
  AI_PACK_INTQ_INFO(
    AI_PACK_INTQ_SCALE(0.003919731825590134f),
    AI_PACK_INTQ_ZP(-128)))
...
AI_TENSOR_OBJ_DECLARE(
  ...
  3, 0x1,
  AI_SHAPE_INIT(4, 40, 64, 1, 1), AI_STRIDE_INIT(4, 1, 40, 2560, 2560),
...
AI_STATIC_CONST ai_i32 nl_3_nl_params_data[] = { 1755275136, 25, -62 };
AI_ARRAY_OBJ_DECLARE(
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_network_activations_map, 1, params)) {
    ...
    serving_default_input_10_output_array.data = AI_PTR(g_network_activations_map[0] + 32);
    serving_default_input_10_output_array.data_start = AI_PTR(g_network_activations_map[0] + 32);
    gemm_0_scratch0_array.data = AI_PTR(g_network_activations_map[0] + 72);
    gemm_0_scratch0_array.data_start = AI_PTR(g_network_activations_map[0] + 72);
    gemm_0_output_array.data = AI_PTR(g_network_activations_map[0] + 152);
    gemm_0_output_array.data_start = AI_PTR(g_network_activations_map[0] + 152);
    ...
    gemm_1_output_array.data = AI_PTR(g_network_activations_map[0] + 216);
    gemm_1_output_array.data_start = AI_PTR(g_network_activations_map[0] + 216);
    gemm_2_scratch0_array.data = AI_PTR(g_network_activations_map[0] + 24);
    gemm_2_scratch0_array.data_start = AI_PTR(g_network_activations_map[0] + 24);
    gemm_2_output_array.data = AI_PTR(g_network_activations_map[0] + 248);
    gemm_2_output_array.data_start = AI_PTR(g_network_activations_map[0] + 248);
    ...
    nl_3_output_array.data = AI_PTR(g_network_activations_map[0] + 248);
    nl_3_output_array.data_start = AI_PTR(g_network_activations_map[0] + 248);
    return true;
  }
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_network_weights_map, 1, params)) {
    ...
    gemm_0_bias_array.data = AI_PTR(g_network_weights_map[0] + 2560);
    gemm_0_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 2560);
    gemm_1_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_1_weights_array.data = AI_PTR(g_network_weights_map[0] + 2816);
    gemm_1_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 2816);
    gemm_1_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_1_bias_array.data = AI_PTR(g_network_weights_map[0] + 4864);
    gemm_1_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 4864);
    gemm_2_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_2_weights_array.data = AI_PTR(g_network_weights_map[0] + 4992);
    gemm_2_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 4992);
    gemm_2_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_2_bias_array.data = AI_PTR(g_network_weights_map[0] + 5120);
    gemm_2_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 5120);
    return true;
  }
